...
import { DELETE_USER_ROUTE } from "../utils/constants";
import {
  HOST,
  IMAGES_URL,
  SET_USER_IMAGE,
...
function Profile() {
  ...
  const deleteUser = async () => {
    try {
        // Call the DELETE endpoint to remove the user from the database
        await axios.delete(DELETE_USER_ROUTE, { withCredentials: true });
